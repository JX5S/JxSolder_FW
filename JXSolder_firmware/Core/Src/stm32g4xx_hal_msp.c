...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  */
    ...
    PA1     ------> ADC1_IN2
    */
    GPIO_InitStruct.Pin = THERMOCOUPLE_Pin|CURRENT_Pin;
  ...
  */
    ...
    PA7     ------> ADC2_IN4
    */
    GPIO_InitStruct.Pin = VBUS_CAPS_Pin|VBUS_DOCK_Pin|VBUS_USB_Pin|VBUS_XT60_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN2
    */
    HAL_GPIO_DeInit(GPIOA, THERMOCOUPLE_Pin|CURRENT_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PA7     ------> ADC2_IN4
    */
    HAL_GPIO_DeInit(GPIOA, VBUS_CAPS_Pin|VBUS_DOCK_Pin|VBUS_USB_Pin|VBUS_XT60_Pin);
